...
import { Plus, Check, Wallet, TrendingUp, Leaf, CheckSquare } from 'lucide-react';
    ...
    <div className="px-4 space-y-6">
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between px-2">
          <h2 className="text-lg font-bold font-title">Resumen de Gastos</h2>
        ...
        <div className="flex gap-4 overflow-x-auto pb-2">
          ...
          <div className="flex-shrink-0 w-44 p-5 rounded-3xl bg-[rgba(25,51,34,0.45)] backdrop-blur-[20px] border border-[#13ec5b]/20 bg-[#13ec5b]/5">
            ...
            <p className="text-xl font-black text-[#13ec5b]">+{totalExpenses > 0 ? ((naturalExpenses / totalExpenses) * 100).toFixed(0) : '0'}%</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4 mb-24">
        <div className="flex items-center justify-between px-2">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold font-title">Tareas Pendientes</h2>
          </div>
          <button 
